...
Only the scalar, non-reversed, variable-length path is vendored: that is the
one the Gated Delta Product prefill calls. Upstream also carries vector-valued
and global variants plus a reverse mode, none of which this fork reaches.
"""
